...
using OwlSchool.Application.Features.Auths.Commands.EnableEmailAuthenticator;
using OwlSchool.Application.Features.Auths.Commands.EnableOtpAuthenticator;
using OwlSchool.Application.Features.Auths.Commands.Login;
using OwlSchool.Application.Features.Auths.Commands.RefleshToken;
using OwlSchool.Application.Features.Auths.Commands.Register;
using OwlSchool.Application.Features.Auths.Commands.RevokeToken;
using OwlSchool.Application.Features.Auths.Commands.VerifyEmailAuthenticator;
using OwlSchool.Application.Features.Auths.Commands.VerifyOtpAuthenticator;
